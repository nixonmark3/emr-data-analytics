...
public class SaveQueryDb extends BlockDefinition implements IExport {

    @Override
    public Definition createDefinition() {

        Definition definition = new Definition("SaveQueryDb", "Save Query Db", Category.DATA_SOURCES.toString());
