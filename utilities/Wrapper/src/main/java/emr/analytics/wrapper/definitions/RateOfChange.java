...
public class RateOfChange extends BlockDefinition implements IExport {

    @Override
    public Definition createDefinition() {

        Definition definition = new Definition("RateOfChange", "Rate of Change", Category.TRANSFORMERS.toString());
        definition.setDescription("Determines the rate of change of a given data frame");
        return definition;
    }
