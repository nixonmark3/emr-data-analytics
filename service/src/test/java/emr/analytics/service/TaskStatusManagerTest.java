...
public class TaskStatusManagerTest {
    ...
    public void testJobStatus() throws Exception {
        ...
        /*new JavaTestKit(system) {{
            ...
            final ActorRef taskStatusManager = system.actorOf(Props.create(TaskStatusManager.class, getRef(), probe.getRef(), request));

            // retrieve the initialized job info
            taskStatusManager.tell("info", getRef());
            ...
            taskStatusManager.tell(status, getRef());
            ...
            taskStatusManager.tell(PoisonPill.getInstance(), getRef());
        }};*/
    }
}