...
public class SparkProcess {
    ...
    public static void main(String[] args){
        ...
        String host = args[2];
        String port = args[3];
        String diagramName = args[4];
        String targetEnvironment = args[5];
        String mode = args[6];
        ...
        actorSystem.actorOf(Props.create(SparkActor.class, path, diagramName, targetEnvironment, mode), "spark-job");
    }
}
