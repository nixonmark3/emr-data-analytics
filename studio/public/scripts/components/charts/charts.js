        ...
        return {
            ...
            link: function ($scope, element, attrs) {
                ...
                var render = function () {
                    ...
                    var features = $scope.chartData.filter(function (value, index) {
                        return (index > 1);
                    });
                    ...
                    var yMin = d3.min(features.map(function (feature) {
                        return d3.min(feature);
                    }));
                    var yMax = d3.max(features.map(function (feature) {
                        return d3.max(feature);
                    }));
