...
def driver():
  ...
  "columns": [
    ...
    savgolay = SavGolay('SavGolay1')
    savgolay.parameters = {'PointsToRight': 10, 'PointsToLeft': 10,'PolynomialOrder' : 5 }
    savgolay.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(savgolay)
