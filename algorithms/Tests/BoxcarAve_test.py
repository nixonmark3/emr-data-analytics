...
from BoxcarAve import BoxcarAve
...
def driver():
  ...
  "columns": [
    ...
    boxcar = BoxcarAve('Boxcar1')
    boxcar.parameters = {'WindowSize': 1000}
    boxcar.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(boxcar)
