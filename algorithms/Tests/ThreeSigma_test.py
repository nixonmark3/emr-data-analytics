...
from ThreeSigma import ThreeSigma
...
def driver():
  ...
  "columns": [
    ...
    threesigma = ThreeSigma('ThreeSig1')
    threesigma.parameters = {'MovingWindow': 20, 'g-Sigma': 3}
    threesigma.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(threesigma)
