...
def driver():
  ...
  "columns": [
    ...
    ewmstdev = EWMStDev('EWMStDev1')
    ewmstdev.parameters = {'Weight': 1000}
    ewmstdev.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(ewmstdev)
