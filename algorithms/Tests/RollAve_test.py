...
from RollingAve import RollingAve
...
def driver():
  ...
  "columns": [
    ...
    rollingave = RollingAve('RollingAve1')
    rollingave.parameters = {'WindowSize': 1000}
    rollingave.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(rollingave)
