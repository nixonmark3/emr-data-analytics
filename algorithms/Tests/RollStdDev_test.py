...
from RollingStdDev import RollingStdDev
...
def driver():
  ...
  "columns": [
    ...
    rollingstddev = RollingStdDev('RollingStdDev1')
    rollingstddev.parameters = {'WindowSize': 1000}
    rollingstddev.input_connectors = {'in' : ['Columns1/out']}
    blocks_to_execute.append(rollingstddev)
