...
from Sensitivity import PLSSensitivity
...
def driver():
  ...
  "columns": [
    ...
    columns2.parameters = {'Columns': ['630_MASS_FRAC_C5']}
    columns2.input_connectors = {'in': ['DataBrick1/out']}
    blocks_to_execute.append(columns2)

    sensitivity = PLSSensitivity('Sensitivity1')
    sensitivity.input_connectors = {'x' : ['Columns1/out'], 'y' : ['Columns2/out']}
