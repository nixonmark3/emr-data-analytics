...
class LagCorrXY(FunctionBlock):
    ...
    def execute(self, results_table):
        try:
            ...
            df_y = results_table[self.input_connectors['y'][0]]
                ...
                for x_tag in df.columns:
                    ...
                    for ii in lag:
                        ...
                        if ii < 0:
                            ...
                            result.append(pearsonr(y, x))
                        elif ii > 0:
                            result.append(pearsonr(y[ii:], x[:-ii]))

                    df_result['{0}x{1}'.format(y_tag, x_tag)] = [r[0] for r in result]
                    col_name = y_tag + '_x_' + x_tag
